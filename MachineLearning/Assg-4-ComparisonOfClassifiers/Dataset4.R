...
#d <- read.csv("https://archive.ics.uci.edu/ml/machine-learning-databases/breast-cancer-wisconsin/wdbc.data", header=FALSE, sep = ",")
#View(d)
#is.na(d)
...
for(i in 1:10) 
{
  ...
  lRTrainModel <- glm(as.factor(V2) ~ V3 + V6 + V7 +V17 +V25+V26 +V27, data = trainingData, family = "binomial") 
  #predict
